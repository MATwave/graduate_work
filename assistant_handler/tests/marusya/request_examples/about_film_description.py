description_request = {
  ...
  "request": {
    "command": "о чем этот фильм",
    "original_utterance": "о чем этот фильм",
...
description_response = {
  "response": {
    "text": "Шейн Доусон проводит интервью и проводит день с одним из самых интересных и противоречивых людей в Интернете, Джеффри Стар, в серии из пяти частей.",
    "end_session": False
  },
  "session": {
    "session_id": "ea660359-9a97-49b3-a043-15546672ea48",
